...
describe('button-date-picker', () => {
  ...
  it('should return the chosen date', () => {
    ...
    render(<ButtonDatePicker value={new Date()} onChange={value => date = value}>Button</ButtonDatePicker>);
    
    const button = screen.getByText('Button');

    fireEvent.click(button);

    const availableDaysElement = document.querySelectorAll('.react-datepicker__day');
